...
<head>
    ...
    <title>SENAWAN171|ALLBINS</title>
        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-body text-center">
              <h4 class="title mb-2">SENAWAN171|ALLBINS</h4>
...
*/
      ...
      if (total > 10000) {
        Swal.fire({
          title: 'Limite de 10K de Linhas Exedido!', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000
        });
        return false;
      }
